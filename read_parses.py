...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', '-i', type=str, default='data/paranmt500k-tab2newline.txt.out', 
                       help="input file")
    parser.add_argument('--output', '-o', type=str, default='data/parsed-paranmt500k-tab2newline.csv', 
                       help="output file")
